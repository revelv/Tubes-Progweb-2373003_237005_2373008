...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Recommendation</h2>
                    <h3 class="section-subheading text-muted">Check out our top product!</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/1.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">GT-60</div>
                                <div class="portfolio-caption-subheading text-muted">Cute Keyboard!</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/2.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Agar</div>
                                <div class="portfolio-caption-subheading text-muted">Black Stylish</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/3.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Keycaps Dongle</div>
                                <div class="portfolio-caption-subheading text-muted">Customize your desk!</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/4.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">PBT Double-shot Retro White</div>
                                <div class="portfolio-caption-subheading text-muted">Old but Gold</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/5.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Chery MX Black Switch</div>
                                <div class="portfolio-caption-subheading text-muted">Makes typing more comfortable!</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                                ...
                                <img class="img-fluid" src="assets/img/rekomendasi/6.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Crystalized Harmony Keycaps</div>
                                <div class="portfolio-caption-subheading text-muted">The Forgotten One</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Sebuah ide lahir di garasi kecil. Tiga pecinta mekanikal keyboard, frustasi dengan keyboard biasa dan mulai merakit switch sendiri.
                            </p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Stryk Industries resmi berdiri dengan workshop pertama di Bandung. 
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Luncurkan Mark-Alims, Sebuah Custom Keyboard dengan Chery MX Switch dan casing aluminum CNC. Harga premium, tapi pasar profesional menyukainya.
                            </p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Kini Styrk Industries berfokus menjadi penyedia Keyboard Bundle dan Custom Keyboard serta menjadi inspirasi bagi dunia.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">Passion di Setiap Switch, Dedikasi di Setiap Layout – Inilah Wajah di Balik Keyboard Custom Anda.</p></div>
                </div>
            </div>
        </section>
        <!-- Clients-->
